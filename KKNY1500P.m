...
%% 1. LOAD DATA
XN = load('3.NormalY_1500RPM_-_17_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_y');
RAWN = reshape(XN.Data1_AI_2_Accelerometer_y, 100000, 360);

XA2 = load('18._PARARELY_0.2_1500RPM_-_20_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_y');
RAWA2 = reshape(XA2.Data1_AI_2_Accelerometer_y, 100000, 360);

XA4 = load('21._PARARELY_0.4_1500RPM_-_21_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_y');
RAWA4 = reshape(XA4.Data1_AI_2_Accelerometer_y, 100000, 360);

XA6 = load('24._PARARELY_0.6_1500RPM_-_21_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_y');
RAWA6 = reshape(XA6.Data1_AI_2_Accelerometer_y, 100000, 360);

XA8 = load('27._PARARELY_0.8_1500RPM_-_21_Jan_24_Recombined.mat', 'Data1_AI_2_Accelerometer_y');
