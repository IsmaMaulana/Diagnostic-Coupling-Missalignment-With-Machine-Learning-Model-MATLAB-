...
%% 1. LOAD DATA
XN = load('2.NormalZ_1000RPM_-_16_Des_24_Recombined.mat', 'Data1_AI_3_Accelerometer_z');
RAWN = reshape(XN.Data1_AI_3_Accelerometer_z, 100000, 360);

XA2 = load('5.ANGULAR0.2Z_1000RPM_-_17_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_z');
RAWA2 = reshape(XA2.Data1_AI_2_Accelerometer_z, 100000, 360);

XA4 = load('8.ANGULAR0.4Z_1000RPM_-_17_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_z');
RAWA4 = reshape(XA4.Data1_AI_2_Accelerometer_z, 100000, 360);

XA6 = load('11._ANGULAR_0.6Z_1000RPM_-_18_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_z');
RAWA6 = reshape(XA6.Data1_AI_2_Accelerometer_z, 100000, 360);

XA8 = load('14.ANGULAR0.8Z_1000RPM_-_19_Des_24_Recombined.mat', 'Data1_AI_2_Accelerometer_z');
