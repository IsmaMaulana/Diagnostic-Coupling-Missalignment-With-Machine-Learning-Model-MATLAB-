...
%% 1. LOAD DATA
XN = load('2.NormalZ_1000RPM_-_16_Des_24_Recombined', 'Data1_AI_3_Accelerometer_z');
RAWN = reshape(XN.Data1_AI_3_Accelerometer_z, 100000, 360);

XA2 = load('17._PARARELZ_0.2_1000RPM_-_20_Des_24_Recombined.mat', 'Data1_AI_3_Accelerometer_z');
RAWA2 = reshape(XA2.Data1_AI_3_Accelerometer_z, 100000, 360);

XA4 = load('20._PARARELZ_0.4_1000RPM_-_20_Des_24_Recombined.mat', 'Data1_AI_3_Accelerometer_z');
RAWA4 = reshape(XA4.Data1_AI_3_Accelerometer_z, 100000, 360);

XA6 = load('23._PARARELZ_0.6_1000RPM_-_21_Des_24_Recombined.mat', 'Data1_AI_3_Accelerometer_z');
RAWA6 = reshape(XA6.Data1_AI_3_Accelerometer_z, 100000, 360);

XA8 = load('26._PARARELZ_0.8_1000RPM_-_21_Jan_24_Recombined.mat', 'Data1_AI_3_Accelerometer_z');
RAWA8 = reshape(XA8.Data1_AI_3_Accelerometer_z, 100000, 360);
...
numClasses = 5;
samplesPerClass = 360;
classNames = {'Normal', 'Angular0.2', 'Angular0.4', 'Angular0.6', 'Angular0.8'};
